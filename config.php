...
define('PF_NO_USER', array(1, 2, 3, 4, 5, 10, 11, 18, 19, 20)); // Для неавторизованного пользователя (анонима)
define('PF_SIMPLE_USER', array(1, 2, 3, 4, 6, 7, 10, 18, 19, 20)); // Для обычного пользователя
define('PF_ADMIN', array(1, 2, 3, 4, 6, 7, 8, 9, 10, 12, 13, 14, 15, 16, 17, 18, 19, 20)); // Для администратора ресурса
